...
*  The heatmap on this page illustrates the degree of difference between the 4th and 5th macro cut of 2023.
...
```{r, fig.width=16, fig.height=12, fig.retina=2}
share_plot(region_shares, "bc_region")+ 
...
```{r, fig.retina=2}
renderPlot({
  share_plot(industry_shares, "industry")
})
```
